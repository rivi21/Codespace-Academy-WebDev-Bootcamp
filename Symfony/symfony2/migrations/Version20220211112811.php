 ...
 */
final class Version20220211112811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entrada (id INT AUTO_INCREMENT NOT NULL, categoria_id INT NOT NULL, usuario_id INT DEFAULT NULL, slug VARCHAR(255) NOT NULL, titulo VARCHAR(255) NOT NULL, fecha DATETIME NOT NULL, estado INT NOT NULL, resumen LONGTEXT NOT NULL, texto LONGTEXT DEFAULT NULL, INDEX IDX_C949A2743397707A (categoria_id), INDEX IDX_C949A274DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etiqueta_entrada DROP FOREIGN KEY FK_97999198A688222A');
